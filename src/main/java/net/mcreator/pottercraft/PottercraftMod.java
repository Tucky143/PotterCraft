package net.mcreator.pottercraft;
...
public class PottercraftMod {
	public static final Logger LOGGER = LogManager.getLogger(PottercraftMod.class);
	public static final String MODID = "pottercraft";

	public PottercraftMod(IEventBus modEventBus) {
